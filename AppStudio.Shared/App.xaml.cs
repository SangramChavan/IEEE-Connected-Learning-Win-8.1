...
namespace AppStudio
{
    ...
    {
        private Guid APP_ID = new Guid("2827a6fc-ad62-4bb9-bf06-2906265aef33");
        public const string APP_NAME = "IEEE Connected Learning";
        ...
        {
            TileServices.CreateFlipTile(@"Bright Minds. Bright Ideas.", @"IEEE Collabratec™");
        }
        #endregion
    }
}
