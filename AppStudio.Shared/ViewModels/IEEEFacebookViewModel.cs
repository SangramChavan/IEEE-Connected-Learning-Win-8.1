...
{
    public class IEEEFacebookViewModel : ViewModelBase<FacebookSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<FacebookSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("IEEEFacebookDetail", item);
                        });
                }
        ...
        {
            return new IEEEFacebookDataSource(); // FacebookDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("IEEEFacebookList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("IEEEFacebookDetail");
        }
    }
}
